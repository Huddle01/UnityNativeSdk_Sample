...
using Unity.WebRTC;
    ...
    public class AudioSpectrumView : MonoBehaviour
    {
        ...
        public AudioStreamTrack _audioTrack;

        public bool StartGraph;
        ...
        void Update()
        {
            ...
            {
                _audioTrack.Source.GetSpectrumData(spectrum, lineIndex, FFTWindow.Rectangular);
